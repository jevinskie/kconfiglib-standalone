...
_conf_filename: str
_conf_changed: bool
_minconf_filename: str
_show_all: bool
_cur_menu: MenuNode
_id_to_node: dict[str, MenuNode]
_jump_to_matches: list
_root: Tk
_tree: ttk.Treeview
_menupath: ttk.Label
_treeview_rowheight: int
_status_label: ttk.Label
_jump_to_tree: ttk.Treeview | None
_entry_res: str | None
_backbutton: ttk.Button
_single_menu_var: BooleanVar
_show_all_var: BooleanVar
_single_menu: bool
_icon_img: PhotoImage
_n_bool_img: PhotoImage
_y_bool_img: PhotoImage
_n_tri_img: PhotoImage
_m_tri_img: PhotoImage
_y_tri_img: PhotoImage
_m_my_img: PhotoImage
_y_my_img: PhotoImage
_n_locked_img: PhotoImage
_m_locked_img: PhotoImage
_y_locked_img: PhotoImage
_not_selected_img: PhotoImage
_selected_img: PhotoImage
_edit_img: PhotoImage
...
def _load_images():
    # Loads GIF images, creating the module _*_img PhotoImage variables.
    # Base64-encoded images embedded in this script are used.
    def load_image(data):
        return PhotoImage(data=data, format="gif")

    # Note: Base64 data can be put on the clipboard with
    #   $ base64 -w0 foo.gif | xclip

    global _icon_img
    _icon_img = load_image(
    ...
    global _y_locked_img
    _y_locked_img = load_image(
...
def _create_kconfig_desc(parent):
    ...
    desc = Text(frame, height=12, wrap="word", borderwidth=0, state="disabled")
